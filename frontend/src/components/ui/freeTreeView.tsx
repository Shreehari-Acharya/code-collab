...
type FolderProps = {
  ...
  element: string;
  isSelectable?: boolean;
  handleSelect?: (id: string) => void; // custom select handler (modified from original)
  isSelect?: boolean;
    ...
    return (
      ...
      >
        <AccordionPrimitive.Trigger
          ...
          onClick={() => {handleExpand(value); handleSelect?.(value)}}  // custom select handler (modified from original)
        >
  ...
  (
    ...
    return (
      <button
        ...
        onClick={() => {selectItem(value); handleSelect?.(value)}} // custom select handler (modified from original)
        {...props}
      >
